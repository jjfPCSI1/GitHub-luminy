...
\input{slides/01_ancien_protocole.tex}

% git, GitHub et Classroom
\input{slides/02_presentation_git_github.tex}

% Exemples d'utilisation et divers avantages
\input{slides/03_utilisation_IRL.tex}


% Structuration des devoirs
\input{slides/05_utilisations_possibles.tex}
